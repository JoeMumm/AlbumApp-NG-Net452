namespace AlbumApp.Data.Migrations
{
  ...
  internal sealed class Configuration : DbMigrationsConfiguration<AlbumApp.Data.AlbumContext>
  {
    public Configuration() { AutomaticMigrationsEnabled = true; }

    Random _rand;

    protected override void Seed(AlbumApp.Data.AlbumContext context)
    {
    ...
    context.AlbumSet.AddOrUpdate(a => a.Title,
      new Album { AlbumNumber = "BRJZ-MrDo-001", Title = "To Brazil and Bacharach", Artist = "Mary D' Orazi", Genre = 2,
        Image = "https://cdbaby.name/m/a/marydoraziwithmarcossilv.jpg", 
        Price = 15m, StockAmount = 1000 },
      new Album { AlbumNumber = "ACJZ-MnSt-010", Title = "Afro Rhythm", Artist = "Mongo Santamaria", Genre = 1,
        Image = "https://img.discogs.com/UMc853TFZcBEBcH37_eGiMXGlEw=/fit-in/300x300/filters:strip_icc():format(jpeg):mode_rgb():quality(40)/discogs-images/R-4665832-1371569632-3688.jpeg.jpg", 
        Price = 15m, StockAmount = 1000 }, 
      new Album { AlbumNumber = "ClCN-NTWB-050", Title = "Dream Catchers", Artist = "North Texas Wind Symphony", Genre = 3,
        Image = "https://img.discogs.com/kpmUs88-XY4YmjnIclpkeN87PMg=/fit-in/300x300/filters:strip_icc():format(jpeg):mode_rgb():quality(40)/discogs-images/R-4838639-1377096578-3770.jpeg.jpg",
        Price = 15m, StockAmount = 1000 },
      new Album { AlbumNumber = "RCRL-Btls-012", Title = "Sgt. Pepper's Lonely Hearts Club Band", Artist = "Beatles", Genre = 5,
        Image = "https://img.discogs.com/5niM71_Gc3Zkk6VK4cRlpHpQRIY=/fit-in/600x590/filters:strip_icc():format(jpeg):mode_rgb():quality(90)/discogs-images/R-499497-1456047383-9489.jpeg.jpg",
        Price = 15m, StockAmount = 1000 });
      context.SaveChanges();
    ...
    for (int i = 5; i < 20; i++) {
      ...
      new Album { AlbumNumber = "XYZZ-AbCd-" + i, Title = ((char)GetRandom(65, 91)).ToString() + ((char) GetRandom(97, 123)).ToString() + "Album # " + i,
        Image = "https://img.discogs.com/BeECgCwj8Xiz0qVfG1VXuUg1rwE=/fit-in/300x300/filters:strip_icc():format(jpeg):mode_rgb():quality(40)/discogs-images/R-6323232-1416456365-9025.jpeg.jpg",
